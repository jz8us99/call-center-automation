...
// Arrow Up (Outbound)
export const ArrowUpIcon: React.FC<IconProps> = ({ className = 'h-4 w-4' }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 16 16">
    <path
      fillRule="evenodd"
...
export const QuestionMarkIcon: React.FC<IconProps> = ({
  ...
  <svg className={className} fill="currentColor" viewBox="0 0 16 16">
    ...
    <path d="M5.255 6.033.274.782C.376.641.627.394.894.3.267.407.527.908.527 1.657c0 .302-.025.607-.025.607h1.125s.025-.305.025-.607c0-.749-.26-1.25-.527-1.657C1.518.659 1.267.406.894 0L.62-.782C.447-1.282.347-1.622.347-2.082c0-.573.348-.875.875-.875s.875.302.875.875c0 .26-.1.6-.273 1.1L1.55-.382h1.125l.274-.6c.173-.5.273-.84.273-1.1 0-1.026-.849-1.875-1.875-1.875S-.127-3.544-.127-2.518c0 .46.1.8.273 1.3z" />
  </svg>
);
...
// Sign out icon
export const SignOutIcon: React.FC<IconProps> = ({ className = 'h-4 w-4' }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// Clear icon (using X symbol)
export const ClearIcon: React.FC<IconProps> = ({ className = 'h-4 w-4' }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// Help icon
export const HelpIcon: React.FC<IconProps> = ({ className = 'h-5 w-5' }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// Check icon
export const CheckIcon: React.FC<IconProps> = ({ className = 'h-4 w-4' }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// X icon
export const XIcon: React.FC<IconProps> = ({ className = 'h-4 w-4' }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
