        ...
        {showPageInput ? (
          <div className="flex items-center gap-2">
            <input
              ...
              placeholder="Page"
              className="w-16 px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500"
            />
            <Button
          ...
          <Button
            ...
            disabled={loading}
            size="sm"
            className="bg-orange-500 hover:bg-orange-600 min-w-[40px]"
